...
export default function TestItem2() {
  return (
    <div
      className="flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 transition-colors duration-500 p-4 rounded-lg shadow-[0_0_15px_5px_#7e22ce]"
