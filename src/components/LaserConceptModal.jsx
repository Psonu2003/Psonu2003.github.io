      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            initial={{ scale: 0.9, y: 50 }} // Animation from slightly smaller/lower
            animate={{ scale: 1, y: 0 }} // Animate to full size/position
            exit={{ scale: 0.9, y: 50 }} // Animate back on close
            transition={{ type: "spring", stiffness: 200, damping: 25 }} // Spring-like animation
          >
            {/* Close Button */}
            <Button
              variant="ghost"
